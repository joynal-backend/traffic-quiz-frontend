  ...
  return (
    <header className="border-b border-gray-200 shadow-md">
      ...
      <div >
          ...
          <ul className="flex items-center justify-between gap-6 mx-6 font-semibold">
            <li className=" ">ავტოსკოლა ვარკეთილში</li>
            <li className="flex items-center">
              <span>
              <Phone className=" bg-[#BE3144] text-white rounded-lg p-[2px] " size={18} />
              </span> 
              <span className="ml-2">
              ...
              <li className="flex items-center">
              <span>
              <Mail className=" bg-[#BE3144] text-white rounded-lg p-[2px] " size={18} />
              </span> 
              <span className="ml-2">
            ...
            <li className="flex items-center gap-2">   <MapPin size={16} color="#c33232" strokeWidth={3} className="text-red-500" />ვარკეთილი, ჯავახეთის N 102</li>
          </ul>
...
<Car size={20}
                         ...
                         className="mb-1 transition-colors duration-200 group-hover:text-green-500 transform r text-gray-700" />            <span>ბილეთები</span>
          </Link>
          <Link
            to="/test"
...
<Car size={20}
                         ...
                         className="mb-1 transition-colors duration-200 group-hover:text-green-500 transform r text-gray-700" />            <span>გამოცდა</span>
          </Link>
        </nav>
      </div>
    </header>
